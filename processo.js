		...
		const DADOS_SISTEMA = {
			...
			exigencias: {
				...
				'002': [
					...
					"02.023 - Em ambientes destinados à concentração de público, a sinalização de orientação e salvamento deverá  ser instalada em altura superior a 1,8m, caso não seja possível sua visualização no plano horizontal. As  dimensões das placas de sinalização deverão estar de acordo com o previsto na tabela 1.1 do anexo 1, de  acordo com a alínea h do item 6.1.3 da NT22/2020-CBMDF.  (Arts. 3º, III, b, e 6º, do Dec. 23.154/2002)",
					"02.024 - A sinalização de orientação e salvamento deve possuir forma quadrada ou retangular, cor do fundo  (cor de segurança) verde, cor do símbolo (cor de contraste) branca ou amarela fotoluminescente, margem  (opcional) fotoluminescente e proporcionalidades paramétricas, de acordo com a Tabela 1.1, do Anexo 1, da  NT22/2020-CBMDF.  (Arts. 3º, III, b, e 6º, do Dec. 23.154/2002)",
					"02.025 - A sinalização de orientação e salvamento deve apresentar efeito fotoluminescente, de acordo com  a alínea a do item 5.7.3 da NT22/2020-CBMDF.  (Arts. 3º, III, b, e 6º, do Dec. 23.154/2002)",
					"02.026 - A sinalização de indicação numérica (cardinal ou ordinal) e alfabética do pavimento no interior das  escadas e antecâmaras deve estar a uma altura de 1,8m medido do piso acabado à base da placa de sinalização,  instalada junto à parede, sobre o patamar de acesso de cada pavimento, de tal forma a ser visualizada em  ambos os sentidos da escada, tanto subida quanto descida e na parede da antecâmara ao lado da porta de  acesso à caixa de escada, de acordo com a alínea f do item 6.1.3 da NT22/2020-CBMDF. (Art. 6º, do Dec.  23.154/2002)",
					"02.027 - A sinalização de identificação de pavimento deve ser instalada em local sempre visível, de tal forma a  ser visualizada em ambos os sentidos da escada, tanto subida quanto descida, conforme alínea f do item  6.1.3 NT22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"02.028 - A sinalização de orientação e salvamento deve assinalar todas as mudanças de direção ou sentido,  saídas, escadas, indicando a rota de fuga, de acordo com o item 6.1.3 da NT22/2020-CBMDF.  (Arts. 3º, III, b,  e 6º, do Dec. 23.154/2002)",
					...
					"02.030 - A sinalização de equipamentos de combate a incêndio deve ser instalada de acordo com a NT22/2020 CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"02.033 - A sinalização de indicação da localização do acionador manual do sistema de detecção e alarme de  incêndio, código 21 da tabela 'd' do anexo 2, deve ser instalada a uma altura entre 0,90m e 1,35m, medida  do piso acabado à base da placa de sinalização, imediatamente ao lado do acionador manual sinalizado, de  acordo com a alínea b do item 6.1.4 da NT22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"02.036 - A sinalização de indicação da localização do abrigo do hidrante de incêndio, com ou sem o hidrante  em seu interior, código 24A da tabela 'd', do anexo 2, deve ser instalada a uma altura de 1,80m, medida do  piso acabado à base da placa de sinalização, imediatamente acima do abrigo do hidrante sinalizado, de acordo  com a alínea e do item 6.1.4 da NT22/2020-CBMDF.  (Art. 6º, do Dec. 23.154/2002)",
					"02.037 - A sinalização de indicação da localização do hidrante de incêndio, instalado fora do abrigo, código 25  da tabela 'd' do anexo 2, deve ser instalada a uma altura de 1,80m, medida do piso acabado à base da placa  de sinalização, imediatamente acima do hidrante sinalizado, de acordo com a alínea f do item 6.1.4 da NT  22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"02.040 - A sinalização de equipamento de combate a incêndio deve possuir forma quadrada ou retangular, cor  do fundo (cor de segurança) vermelha, cor do símbolo (cor de contraste) branca ou amarela fotoluminescente,  margem (opcional) fotoluminescente e proporcionalidades paramétricas, de acordo com a Tabela 1.1 do Anexo  1 da NT22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"02.041 - A sinalização de equipamentos de combate a incêndio deve apresentar efeito fotoluminescente, de  acordo com a alínea b do item 5.7.3 da NT22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"02.042 - Quando os equipamentos de proteção contra incêndio forem instalados em pilares, devem ser  sinalizadas todas as faces de pilar/coluna, preferencialmente à 1,80m de altura, conforme código 28 da tabela  'd' do anexo 2, que estiverem voltadas para os corredores de circulação de pessoas ou veículos, de acordo  com a alínea j do item 6.1.4 da NT22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"02.047 - A sinalização complementar deve ser instalada de acordo com a NT22/2020-CBMDF. (Art. 6º, do Dec.  23.154/2002)",
					...
					"02.051 - Quando for instalada sobre o piso, a sinalização complementar deve estar centralizada em relação à  largura da rota de saída, de acordo com alínea a do item 6.1.5 da NT22/2020-CBMDF.  (Arts. 3º, III, b e 6º, do  Dec. 23.154/2002)",
					"02.052 - A sinalização complementar deve ser usada a cada mudança de direção e sentido, dando o sentido de  fluxo, de acordo com alínea a do item 6.1.5 da NT22/2020-CBMDF.  (Arts. 3º, III, b, e 6º, do Dec. 23.154/2002)",
					"02.053 - A sinalização complementar é obrigatória em ambientes fechados destinados à concentração de  público, de acordo com a alínea a do item 6.1.5 da NT22/2020-CBMDF.  (Arts. 3º, III, b, e 6º, do Dec.  23.154/2002)",
					...
					"02.055 - Para indicar permanência da porta corta-fogo constantemente fechada, instalada sobre a mesma,  código 31 da tabela 'e' do anexo 2, deve ser instalada placa na porta corta-fogo a uma altura entre 1,20m e  1,80m, medida do piso acabado à base da placa de sinalização, de acordo com a alínea c do item 6.1.5 da NT  22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"02.058 - Exclusivamente para boates e danceterias, concentração de público - código 23 da NT01/2016 CBMDF, a sinalização de lotação máxima de público prevista na alínea e do item 6.1.5 da NT22/2020 CBMDF, deve ser instalada de forma obrigatória nos acessos destas áreas, a uma altura de 1,80m, medida do  piso acabado à base da placa de sinalização, de acordo com a Decisão Técnica 011/2021-CSESCIP/CBMDF.",
					...
					"02.064 - As classes e capacidade de armazenamento de recipientes transportáveis de Gás Liquefeito de  Petróleo - GLP, em quilogramas para cada uma dessas, por meio de placas instaladas no acesso principal da  área de risco, de acordo com a alínea d do item 6.2 da NT22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"02.066 - A abertura das portas em escadas não deve obstruir a visualização de qualquer sinalização, de acordo  com a alínea j do item 6.1.3 da NT22/2020-CBMDF.  (Arts. 3º, III, b, e 6º, do Dec. 23.154/2002)",
					"02.067 - Na sinalização de segurança, as expressões escritas utilizadas devem seguir as regras, termos e  vocábulos da língua portuguesa, podendo, complementarmente, e nunca exclusivamente, ser adotada outra  língua estrangeira, de acordo com a alínea d do item 5.5 da NT22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"02.068 - Os equipamentos de origem estrangeira, instalados na edificação, utilizados na segurança contra  incêndio e pânico, devem possuir as orientações necessárias à sua operação na língua portuguesa, de acordo  com a alínea e do item 5.5 da NT22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"02.069 - As dimensões básicas das letras e das placas de sinalização de segurança devem obedecer à relação  apresentada no anexo 1 da NT22/2020-CBMDF.  (Art. 6º, do Dec. 23.154/2002)",
					"02.070 - A sinalização de segurança deve possuir os símbolos gráficos, conforme os apresentados no anexo 2  da NT22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"02.072 - Se existirem rotas de saída específicas para uso de portadores de necessidades especiais, estas devem  ser sinalizadas para tal finalidade, conforme a alínea k do item 6.1.3 da NT22/2020-CBMDF.  (Arts. 3º, III, b, e  6º, do Dec. 23.154/2002)",
					...
					"02.075 - Os acessórios hidráulicos (válvulas de retenção, registros de paragem, válvulas de governo e alarme)  devem receber pintura na cor amarela, de acordo com o inciso III do item 6.3 da NT22/2020-CBMDF. (Art. 6º,  do Dec. 23.154/2002)",
					"02.076 - A tampa de abrigo do registro de recalque deve ser pintada na cor vermelha, de acordo com o inciso  IV do item 6.3 da NT22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
