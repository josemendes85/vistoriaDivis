		...
		const DADOS_SISTEMA = {
			...
			exigencias: {
				...
				'002': [
					...
					"02.025 - A sinalização de indicação numérica (cardinal ou ordinal) e alfabética do pavimento no interior das escadas e antecâmaras deve estar a uma altura de 1,8 m medido do piso acabado à base da placa de sinalização, instalada junto à parede, sobre o patamar de acesso de cada pavimento, de tal forma a ser visualizada em ambos os sentidos da escada, tanto subida quanto descida e na parede da antecâmara ao lado da porta de acesso à caixa de escada, de acordo com a alínea f do item 6.1.3 da NT 22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"02.031 - A sinalização de indicação da localização do acionador manual do sistema de detecção e alarme de incêndio, código 21 da tabela 'd' do anexo 2, deve ser instalada a uma altura entre 0,90 m e 1,35 m, medida do piso acabado à base da placa de sinalização, imediatamente ao lado do acionador manual sinalizado, de acordo com a alínea b do item 6.1.4 da NT 22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"02.034 - A sinalização de indicação da localização do abrigo do hidrante de incêndio, com ou sem o hidrante em seu interior, código 24A da tabela 'd', do anexo 2, deve ser instalada a uma altura de 1,80 m, medida do piso acabado à base da placa de sinalização, imediatamente acima do abrigo do hidrante sinalizado, de acordo com a alínea e do item 6.1.4 da NT 22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"02.035 - A sinalização de indicação da localização do hidrante de incêndio, instalado fora do abrigo, código 25 da tabela 'd' do anexo 2, deve ser instalada a uma altura de 1,80 m, medida do piso acabado à base da placa de sinalização, imediatamente acima do hidrante sinalizado, de acordo com a alínea f do item 6.1.4 da NT 22/2020- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"02.053 - Para indicar permanência da porta corta-fogo constantemente fechada, instalada sobre a mesma, código 31 da tabela 'e' do anexo 2, deve ser instalada placa na porta corta-fogo a uma altura entre 1,20 m e 1,80 m, medida do piso acabado à base da placa de sinalização, de acordo com a alínea c do item 6.1.5 da NT 22/2020-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
				...
				'003': [
					"03.001 - A iluminação de emergência deve ser instalada em conformidade com a NT 21/2020-CBMDF. A iluminação de emergência deve ser adquirida junto às empresas credenciadas pelo CBMDF, com escopo para comercialização da referida medida de segurança contra incêndio e pânico. (Art. 6º, do Dec. 23.154/2002)",
				...
				'004': [
					"04.001 - Os aparelhos extintores de incêndio devem ser instalados em conformidade com a NT 03/2015-CBMDF. O aparelho extintor de incêndio deve ser adquirido junto às empresas credenciadas pelo CBMDF, com escopo para comercialização da referida medida de segurança contra incêndio e pânico. (Art. 6º, do Dec. 23.154/2002)",
					...
					"04.018 - Os aparelhos extintores devem ser instalados de maneira que sejam visíveis, para que todos os usuários fiquem familiarizados com a suas localizações, de acordo com o item 4.1.2.6 e 4.2.2.4 da NT 03/2015-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"04.046 - Devem ser empregados obrigatoriamente extintores sobre rodas nos helipontos e heliportos, conforme alínea f do item 4.2.2.1 da NT 03/2015-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"04.057 - Instalar sinalização de piso, logo abaixo dos extintores (quadrado vermelho 70 x 70 cm com moldura amarela de 15 cm) em garagens, depósitos e indústrias, de acordo com a alínea I do item 6.1.4 da NT 22/2020- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
				...
				'005': [
					...
					"05.012 - Adequar para a edificação as distâncias máximas a percorrer para as edificações com chuveiros automáticos e sistema de detecção automática, de acordo com tabela 6 da Decisão Técnica 04/2021- CSESCIP/CBMDF.",
					...
					"05.040 - A(s) escada(s) enclausurada(s) protegida(s) deve(m) ser dotada(s) de janela ou alçapão de alivio de fumaça que permita a ventilação permanente em seu término superior, com área de abertura efetiva mínima de 1,00 m², podendo estar localizado na parede noteto ou no máximo a 15 cm deste, do término da escada, de acordo com a letra d do item 4.3.1.6.1 da NT 10/2015-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"05.041 - A(s) escada(s) enclausurada(s) protegida(s) deve(m) possuir ventilação permanente inferior, com área de 1,20 m² no mínimo, nosolo, podendo esta ventilação ser por veneziana na própria porta de saída do térreo ou em local conveniente da caixa da escada ou corredor da descarga, que permita a entrada de ar puro, em condições análogas à tomada de ar dos dutos de ventilação, de acordo com o item 4.3.1.8.4 da NT 10/2015- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"05.042 - As janelas das escadas protegidas devem ter área de ventilação efetiva mínima de 0,80 m², em cada pavimento e caixilhos fixados na posição aberta quando do tipo basculante, sendo vedados os tipos de abrir com o eixo vertical e maximar, de acordo com as alíneas b e e do item 4.3.1.6.2 da NT 10/2015-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"05.051 - O conjunto moto - ventilador, para pressurização da escada, deve ser alojado em compartimento de uso exclusivo e possuir em seu acesso porta corta-fogo PF-90, de acordo com a alínea a do item 4.3.1.10.3 da NT 10/2015-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"05.103 - Toda saída de emergência deve ser protegida de ambos os lados por paredes ou guardas (guardacorpos) contínuas, sempre que houver qualquer desnível maior de 19 cm, para evitar quedas, de acordo com o item 4.6.2.1 da NT 10/2015-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"05.104 - As escadas e rampas que não forem isoladas das áreas adjacentes por paredes devem dispor de guardacorpo associado ao corrimão, de acordo com o item 4.6.2.2 da NT 10/2015-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
				...
				'006': [
					"06.001 - O sistema de hidrantes de parede deve ser instalado em conformidade com a NT 04/2000-CBMDF. O sistema de proteção por hidrantes de parede deve ser instalado, adequado e/ou manutenido por empresas credenciadas pelo CBMDF, com escopo para comercialização da referida medida de segurança contra incêndio e pânico, de acordo com o Decreto nº 21.361/2000. (Art. 6º, do Dec. 23.154/2002)",
					...
					"06.032 - Identificar o barramento de energia do conjunto de bombas de incêndio, de acordo com a NT 04/2000- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"06.042 - A canalização de incêndio aparente deve ser pintada na cor vermelha, de acordo com a NT 04/2000- CBMDF. (Arts. 3º, II, g, e 6º, do Dec. 23.154/2002)",
					...
					"06.055 - A pressão na saída do requinte nos hidrantes deve ser entre 10 e 40 mca, de acordo com a NT 04/2000- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"06.059 - Os esguichos dos hidrantes de parede devem ser do tipo reguláveis de acordo com o a NT 04/2000- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"06.064 - Instalar puxadores nas portas dos abrigos dos hidrantes de parede, de acordo com a NT 04/2000- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
				...
				'009': [
					...
					"09.003 - Apresentar documento de responsabilidade técnica (Anotação, Registro ou Termo de Responsabilidade Técnica - ART/RRT/TRT) de execução ou manutenção do sistema de detecção automática e alarme manual de incêndio instalado, emitido por profissional e visado noseu respectivo órgão de classe, de acordo com o Item 15.2.8 da IN 01/2021 - DESEG/CBMDF e Decreto nº 21.361/2000. (Art. 6º, do Dec. 23.154/2002)",
					"09.004 - O sistema de alarme manual de incêndio deve ser instalado em conformidade com a NT 23/2022- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"09.010 - A central deve ser localizada em áreas de fácil acesso e supervisionadas, tais como: salas de controle, salas de segurança, portaria principal ou entrada de edifícios, de acordo com o item 5.4.1 da NT 23/2022-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"09.011 - Na ausência de vigilância permanente da Central após o período de ocupação da edificação, torna-se necessário que a central tenha monitoramento local ou remoto, de acordo com o item 5.4.1 da NT 23/2022- CBMDF.",
					...
					"09.028 - Os detectores pontuais de temperatura devem ser empregados em ambientes com presença de materiais, cuja característica no início da combustão é gerar muito calor e pouca fumaça, devendo-se considerar a temperatura do teto do ambiente para a seleção da temperatura nominal do detector, de acordo com o item 5.5.4.1 da NT 23/2022-CBMDF. (Art. 6º, do Dec. 23.154/2002) Detecção e Alarme de Incêndio",
					"09.029 - A área de cobertura estabelecida para detectores pontuais de temperatura instalados nos tetos dos ambientes em função de eventual desnível apresentado em vigas abaixo da laje, deve seguir a indicação da Tabela 03 - Área máxima de cobertura detector de temperatura, de acordo com o item 5.5.4.3 da NT 23/2022-CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"09.062 - Em locais com elevada concentração de pessoas, o alarme geral pode ser substituído por um sinal sonoro (pré-alarme) apenas na sala de segurança, junto à central, para evitar o pânico, para um acionamento prévio da brigada de incêndio na verificação do sinal de pré-alarme, de acordo com o item 6.6 da NT 23/2022- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					"09.063 - Em locais com elevada concentração de pessoas, a central deve possuir um temporizador para o acionamento posterior do alarme geral, com tempo de retardo de, no máximo 2 minutos, caso não sejam tomadas as ações necessárias para verificar o pré-alarme da central, de acordo com o item 6.6.1 da NT 23/2022- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
				...
				'011': [
					...
					"11.017 - Os quadros de distribuição devem ser instalados em locais de fácil acesso e serem providos de identificação do lado externo, legível e não facilmente removível, de acordo com o item 5.1.8 da NT 41/2024- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
					...
					"11.021 - Os equipamentos destinados a operar em situações de incêndio, de acordo com o prescrito no Regulamento de segurança contra incêndio das edificações e áreas de risco e respectivas Normas Técnicas, devem ter seu funcionamento e desempenho elétrico assegurados pelo tempo necessário para execução das operações de combate ao fogo e salvamento, de acordo com a alínea 'b' do item 6.1.1 da da NT 41/2024- CBMDF. (Art. 6º, do Dec. 23.154/2002)",
				...
				'018': [
					...
					"18.010 - O material armazenado em locais de comércio ou armazenamento de fogos de artifício deverá distar de no mínimo 20 cm abaixo da projeção horizontal da base da abertura de ventilação, conforme NT 08 / 2008 - CBMDF. (Art. 6º, do Dec. 23.154 / 2002)",
